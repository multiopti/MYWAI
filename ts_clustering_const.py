...
def l2_distance(point1, point2):
    ...
    #return dtw.distance(point1, point2)
...
for k in range(len(clusters)):
     if clusters[k] == 0:
         ax.add_patch(Rectangle((k*winlen, -3), winlen, 6,color="salmon"))
     if clusters[k] == 1:
         ax.add_patch(Rectangle((k*winlen, -3), winlen, 6,color="aquamarine"))
ax.plot(t, S, 'b')
